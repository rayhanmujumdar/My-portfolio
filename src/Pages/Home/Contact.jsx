      ...
      <div className="grid md:grid-cols-2 gap-x-5">
        <div className="flex flex-col gap-y-1.5 p-3">
          ...
          <div className="flex gap-x-2 items-center">
            <i class="fa-solid fa-envelope text-[#A16207] text-2xl"></i>
            <a
          ...
          <div className="flex gap-x-2 items-center">
            <i class="fa-solid fa-phone text-[#A16207] text-2xl"></i>
            <a
          ...
          <div className="flex gap-x-2 items-center">
            <i class="fa-solid fa-location-dot text-[#A16207] text-2xl"></i>
            <a
