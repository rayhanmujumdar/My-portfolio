...
const Banner = () => {
    return (
        <div id='banner' className="h-[93vh] flex justify-center items-center flex-col bg-[#112B3C]" style={{"clipPath":'polygon(50% 0%, 100% 0, 100% 43%, 100% 78%, 100% 100%, 73% 88%, 0 100%, 0% 43%, 0 0)'}}>
